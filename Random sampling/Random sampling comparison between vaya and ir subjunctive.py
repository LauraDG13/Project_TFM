...
list_sub_verbs = ["vaya", "vayas", "vayamos", "vayan"]
...
plt.title(f"Chronological evolution of 'vaya' compared to the present subjunctive of 'ir' with sample1M", fontsize=280)
...
#plt.savefig(elem+'sample_ir.pdf', format="pdf", bbox_inches="tight")
